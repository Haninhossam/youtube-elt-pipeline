    ...
    try:
        while True:
            ...
            for item in data.get('items' ,[]):
                viedeo_id = item['contentDetails']['videoId']
                viedeo_ids.append(viedeo_id)
    ...
    try:
        for batch in batch_list(video_ids ,max_result):
            ...
            for item in data.get('items' , []):
                ...
                extracted_data.append(viedeo_data)
...
if __name__ == "__main__":
    ...
    video_ids =get_viedeo_ids(playlistid)
    viedo_data = (extract_video_data(video_ids))
    save_to_json(viedo_data)
